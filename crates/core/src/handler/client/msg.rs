...
use libbridgething::{
  ...
  client::{
    ...
    ClientToBridgeDocMsgRequest, ClientToBridgeGeoMsg, ClientToBridgeHardwareMsg, ClientToBridgeInputMsg,
    ClientToBridgeLibraryMsg, ClientToBridgeLyricsMsg, ClientToBridgeMsg, ClientToBridgeMsgData, ClientToBridgeNetMsg,
...
impl From<ClientToBridgeMsg> for RecvMsgData {
  fn from(msg: ClientToBridgeMsg) -> Self {
    match msg.data {
      ...
      ClientToBridgeMsgData::Input(inner) => Self::Input(inner),
